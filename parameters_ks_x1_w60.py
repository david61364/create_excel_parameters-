...
store_name = store_name.lower()     # changes var to lowercase and
store_name = store_name.replace(" ", "")         # takes out all of the spaces

store_number = input("Enter store number: ")
store_number = int(store_number)    # Storing input as int

var_voicemail_parameter_group = (f"{store_name}_{store_number}_x1_w60") # Naming the parameter group
var_voicemail_user_name = store_number * 100  # Building the extension numbers
var_sales_floor_1_name = var_voicemail_user_name +1
var_sales_floor_2_name = var_voicemail_user_name +2

# Create the batch device parameter group
workbook = xlsxwriter.Workbook(f"BatchDeviceParameter_{var_voicemail_parameter_group}.xlsx")
...
worksheet.write('D10', var_sales_floor_2_name)
...
worksheet.write('D11', var_sales_floor_2_name)
...
worksheet.write('D17', var_sales_floor_2_name)
...
worksheet.write('D18', var_sales_floor_2_name)
...
worksheet.write('A23', var_voicemail_parameter_group)
worksheet.write('B23', 'SET')
worksheet.write('C23', 'account.3.auth_name')
worksheet.write('D23', var_sales_floor_1_name)
worksheet.write('E23', 'disabled')

worksheet.write('A24', var_voicemail_parameter_group)
worksheet.write('B24', 'SET')
worksheet.write('C24', 'account.3.user_name')
worksheet.write('D24', var_sales_floor_1_name)
worksheet.write('E24', 'disabled')

worksheet.write('A25', var_voicemail_parameter_group)
worksheet.write('B25', 'SET')
worksheet.write('C25', 'account.3.display_mwi.enable')
worksheet.write('D25', 1)
worksheet.write('E25', 'disabled')

worksheet.write('A26', var_voicemail_parameter_group)
worksheet.write('B26', 'SET')
worksheet.write('C26', 'account.3.outbound_proxy.1.address')
worksheet.write('D26', 'proxy-ucc.genband.com')
worksheet.write('E26', 'disabled')

worksheet.write('A27', var_voicemail_parameter_group)
worksheet.write('B27', 'SET')
worksheet.write('C27', 'account.3.outbound_proxy_enable')
worksheet.write('D27', 1)
worksheet.write('E27', 'disabled')

worksheet.write('A28', var_voicemail_parameter_group)
worksheet.write('B28', 'SET')
worksheet.write('C28', 'account.3.password')
worksheet.write('D28', '<password>')
worksheet.write('E28', 'disabled')

worksheet.write('A29', var_voicemail_parameter_group)
worksheet.write('B29', 'SET')
worksheet.write('C29', 'account.3.sip_server.1.address')
worksheet.write('D29', 'att-ni-ics.com')
worksheet.write('E29', 'disabled')

worksheet.write('A30', var_voicemail_parameter_group)
worksheet.write('B30', 'SET')
worksheet.write('C30', 'account.3.label')
worksheet.write('D30', var_sales_floor_1_name)
worksheet.write('E30', 'disabled')

worksheet.write('A31', var_voicemail_parameter_group)
worksheet.write('B31', 'SET')
worksheet.write('C31', 'account.3.display_name')
worksheet.write('D31', var_sales_floor_1_name)
worksheet.write('E31', 'disabled')

worksheet.write('A32', var_voicemail_parameter_group)
worksheet.write('B32', 'SET')
worksheet.write('C32', 'handset.2.name')
worksheet.write('D32', 'Sale Floor 1')
worksheet.write('E32', 'disabled')

worksheet.write('A33', var_voicemail_parameter_group)
worksheet.write('B33', 'SET')
worksheet.write('C33', 'handset.2.incoming_lines')
worksheet.write('D33', '3, 1')
worksheet.write('E33', 'disabled')

worksheet.write('A34', var_voicemail_parameter_group)
worksheet.write('B34', 'SET')
worksheet.write('C34', 'handset.2.dial_out_lines')
worksheet.write('D34', '3, 1')
worksheet.write('E34', 'disabled')

worksheet.write('A35', var_voicemail_parameter_group)
worksheet.write('B35', 'SET')
worksheet.write('C35', 'handset.2.dial_out_default_line')
worksheet.write('D35', 1)
worksheet.write('E35', 'disabled')
